...
daytrace-session Phase 4（Pattern Mining）の **classification overlay**（`classification-prompt.md` に従った 1 候補 1 JSON）は、LLM 呼び出しコストとユーザー認知負荷を抑えるため、**全候補ではなく「曖昧な候補だけ」**に限定する。
...
- 手順の全体: `skills/daytrace-session/SKILL.md` Phase 4（Pattern Mining）
